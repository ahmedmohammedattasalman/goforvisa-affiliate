...
export default function DashboardLayout({
  ...
  const navLinks = [
    ...
    },
    {
      ...
      href: "/dashboard#reports", // Dummy anchor or path
      icon: BarChart3
    },
    {
      name: "الإشعارات",
    ...
    {
      name: "الإعدادات",
      href: "/dashboard/profile#settings", // Link to settings segment of profile
      icon: Settings
    }
  ];
            ...
            <div className="relative">
              ...
              {profileDropdownOpen && (
                <div className="absolute left-0 mt-2 w-48 bg-white border border-slate-100 rounded-xl shadow-lg py-1.5 z-30 text-right">
                  ...
                  <Link href="/dashboard/profile#settings" onClick={() => setProfileDropdownOpen(false)} className="block text-right px-4 py-2 text-xs font-semibold hover:bg-slate-50 text-slate-700">الإعدادات</Link>
